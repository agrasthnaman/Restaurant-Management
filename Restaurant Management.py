...
Tops=Frame(root, width=1600, height=50, bg='lavender', relief=SUNKEN)
Tops.pack(side=TOP)

f1=Frame(root, width=800, height=700, bg='lavender', relief=SUNKEN)
f1.pack(side=LEFT)

f2=Frame(root, width=300, height=700, bg='lavender', relief=SUNKEN)
f2.pack(side=RIGHT)
#=================================TIME====================================================
